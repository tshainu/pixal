  ...
  function submit(e: React.FormEvent) {
    ...
    setTimeout(() => {
      if (username === CREDENTIALS.username && password === CREDENTIALS.password) {
        sessionStorage.setItem('pandora_auth', JSON.stringify({ userId: CREDENTIALS.userId, username }));
        onLogin();
      } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          ...
          {error && (
            <div style={{
              ...
              borderRadius: 8, color: '#DC2626', fontSize: '0.8rem', fontWeight: 500,
            }}>
              {error}
            </div>
          )}
          ...
          <button
            ...
            style={{
              ...
              boxShadow: loading || !username || !password ? 'none' : '0 4px 14px rgba(220,38,38,0.35)',
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.72rem', color: '#9CA3AF' }}>
            User ID: <span style={{ fontWeight: 700, color: '#6B7280', letterSpacing: '0.05em' }}>AX70</span>
          </div>
          <div style={{ fontSize: '0.72rem', color: '#9CA3AF' }}>
            Pandora Garment © {new Date().getFullYear()}
          </div>
        </div>
      </div>
    </div>
